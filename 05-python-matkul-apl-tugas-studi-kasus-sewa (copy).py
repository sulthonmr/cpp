...
while condition < 2:
    ...
    if condition <= 0:
        ...
        if userName == "sulthon" and passWord == "sulthon026":
            condition = 1
        else:
            condition = -1
        ...
        #pilih produk
                ...
                while True:
                    ...
                    if confirmVoucher.upper() == "Y":
                        ...
                        while True:
                            ...
                            if codeVoucher == voucher and jamSekarang.tm_hour >= 12 and jamSekarang.tm_hour < 15 and statusVoucher == 1:
                            ...
                            elif codeVoucher == voucher and jamSekarang.tm_hour < 12 or jamSekarang.tm_hour > 15 and statusVoucher == 1:
                                print(f"\033[31m| Kode voucher \"{voucher}\" hanya dapat digunakan pada jam 12:00 s/d 15:00.\033[m")
            ...
            while True:
                ...
                if confirmBayar.upper() == "Y" and saldoEmoney <= tvHarga[-1]:
                    tvProduk.pop()
                    tvHarga.pop()
                    print("\033[31m| Saldo E-money tidak mencukupi. Transaksi Dibatalkan\033[m")
                    break
                if confirmBayar.upper() == "Y" and saldoEmoney >= tvHarga[-1]:
                    ...
                    if pilihKeranjang.isnumeric() and int(pilihKeranjang) in range(1,len(pesanTVProduk)+1):
                        ...
                        while True:
                            ...
                            if datetime.datetime.now() > pesanTVEXP[pilihKeranjang-1]:
                                ...
                                print("\033[31m| Transaksi gagal. Pemesanan hangus setelah 1 jam\033[m\n")
                                break
                            if bayarKeranjang.upper() == "Y" and saldoEmoney <= pesanTVHarga[pilihKeranjang-1]:
                                print("\033[31m| Saldo E-money tidak mencukupi. Transaksi Dibatalkan\033[m\n")
                                break
                            if bayarKeranjang.upper() == "Y" and saldoEmoney <= pesanTVHarga[pilihKeranjang-1]:
